    ...
    return (
        ...
        <div className="flex justify-center items-center flex-grow bg-no-repeat bg-cover relative">
            ...
            <div className="z-20 bg-white w-full max-w-md rounded-lg shadow p-6 pt-12 flex flex-col">
                ...
                <label htmlFor="" className="font-medium mt-3">Full Name</label>
                <input type="text" className="px-3 py-2 border border-gray-400 mt-1 rounded-lg" placeholder="Your Full Name"/>
                ...
                <label htmlFor="" className="font-medium mt-3">Confirm Password</label>
                <input type="password" className="px-3 py-2 border border-gray-400 mt-1 rounded-lg" placeholder="Confirm Password"/>
